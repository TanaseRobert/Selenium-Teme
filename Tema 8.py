...
chrome.find_element(By.ID, 'autocomplete').send_keys('Block No.7 - Second floor - The fourth apartment')
chrome.find_element(By.ID, 'street_number').send_keys('Republicii')
chrome.find_element(By.ID, 'route').send_keys('Milcov')
chrome.find_element(By.ID, 'locality').send_keys('Suceava')
chrome.find_element(By.ID, 'administrative_area_level_1').send_keys('Moldovia')
chrome.find_element(By.ID, 'postal_code').send_keys('700492')
...
chrome.find_element(By.ID, 'datepicker').send_keys('03/11/2021')

chrome.get('https://formy-project.herokuapp.com')
chrome.find_element(By.PARTIAL_LINK_TEXT, 'Complete Web Form').click()
chrome.get('https://formy-project.herokuapp.com/form')

chrome.find_element(By.TAG_NAME, 'input').send_keys('Alex')
list_input = chrome.find_elements(By.TAG_NAME, 'input')
list_input[1].send_keys('Vlad')
